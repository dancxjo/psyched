...
pub struct PolygonInstanceStamped {
    pub header: std_msgs::msg::rmw::Header,
    pub polygon: crate::msg::rmw::PolygonInstance,
}
...
pub struct VelocityStamped {
    ...
    pub velocity: crate::msg::rmw::Twist,
}
...
impl Default for PolygonInstance {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::msg::rmw::PolygonInstance::default())
  }
}

impl rosidl_runtime_rs::Message for PolygonInstance {
  type RmwMsg = crate::msg::rmw::PolygonInstance;
...
impl Default for PolygonInstanceStamped {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::msg::rmw::PolygonInstanceStamped::default())
  }
}

impl rosidl_runtime_rs::Message for PolygonInstanceStamped {
  type RmwMsg = crate::msg::rmw::PolygonInstanceStamped;

  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        header: std_msgs::msg::Header::into_rmw_message(std::borrow::Cow::Owned(msg.header)).into_owned(),
        polygon: crate::msg::PolygonInstance::into_rmw_message(std::borrow::Cow::Owned(msg.polygon)).into_owned(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        header: std_msgs::msg::Header::into_rmw_message(std::borrow::Cow::Borrowed(&msg.header)).into_owned(),
        polygon: crate::msg::PolygonInstance::into_rmw_message(std::borrow::Cow::Borrowed(&msg.polygon)).into_owned(),
      })
    }
  }
  ...
  fn from_rmw_message(msg: Self::RmwMsg) -> Self {
    Self {
      header: std_msgs::msg::Header::from_rmw_message(msg.header),
      polygon: crate::msg::PolygonInstance::from_rmw_message(msg.polygon),
    }
  }
}
...
impl Default for VelocityStamped {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::msg::rmw::VelocityStamped::default())
  }
}

impl rosidl_runtime_rs::Message for VelocityStamped {
  type RmwMsg = crate::msg::rmw::VelocityStamped;
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        velocity: crate::msg::Twist::into_rmw_message(std::borrow::Cow::Owned(msg.velocity)).into_owned(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        header: std_msgs::msg::Header::into_rmw_message(std::borrow::Cow::Borrowed(&msg.header)).into_owned(),
        body_frame_id: msg.body_frame_id.as_str().into(),
        reference_frame_id: msg.reference_frame_id.as_str().into(),
        velocity: crate::msg::Twist::into_rmw_message(std::borrow::Cow::Borrowed(&msg.velocity)).into_owned(),
      })
    }
  }
  ...
  fn from_rmw_message(msg: Self::RmwMsg) -> Self {
    Self {
      ...
      velocity: crate::msg::Twist::from_rmw_message(msg.velocity),
    }
  }
}
