...
class MemoryService:
    ...
    def recall(
        ...
        *,
        ...
        result_memory_ids = [result.memory_id for result in results]
        graphs_metadata = self.graph_store.fetch_memories(result_memory_ids)

        enriched: List[MemoryRecallResult] = []
        for result in results:
            graph_metadata = graphs_metadata.get(result.memory_id, {})
            merged_metadata = {
