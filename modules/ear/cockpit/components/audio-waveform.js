 ...
 *
 * The widget expects ByteMultiArray-style ROS messages delivered via the cockpit
 * websocket bridge.  Each clip is converted to a WAV blob so operators can
 * review the captured PCM directly in the browser.
 */
class CockpitAudioWaveform extends LitElement {
  static properties = {
    record: { type: Object },
    topic: { type: Object },
    _clips: { state: true },
...
customElements.define('cockpit-audio-waveform', CockpitAudioWaveform);
