 ...
 *
 * The component fetches log entries from the pilot backend and renders the
 ...
 * Example:
 * ```html
 * <pilot-module-logs module="nav"></pilot-module-logs>
 * ```
 */
class PilotModuleLogs extends LitElement {
  static properties = {
...
customElements.define('pilot-module-logs', PilotModuleLogs);
