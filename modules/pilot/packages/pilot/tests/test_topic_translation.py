...
from pilot.topic_translation import apply_topic_translation, discover_topic_translators
...
def test_apply_topic_translation_enriches_mapping() -> None:
    ...
    translators = {"/foo": lambda value: f"Summary of {value['data']}"}
...
def test_apply_topic_translation_handles_raw_values() -> None:
    translators = {"/foo": lambda value: "Summary"}
...
def test_apply_topic_translation_supports_prefix_keys() -> None:
    translators = {"/foo/*": lambda value: "Prefixed"}
