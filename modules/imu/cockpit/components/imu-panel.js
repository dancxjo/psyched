 ...
 */
class CockpitImuPanel extends LitElement {
  static properties = {
    data: { type: Object },
  };
  ...
  connectedCallback() {
    ...
    window.addEventListener('cockpit-imu', this._handleEvent);
  }

  disconnectedCallback() {
    super.disconnectedCallback();
    window.removeEventListener('cockpit-imu', this._handleEvent);
  }
...
customElements.define('cockpit-imu-panel', CockpitImuPanel);
